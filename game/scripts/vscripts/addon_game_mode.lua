...
function GameMode:InitModifiers()
    ...
    LinkLuaModifier("modifier_knockup", "abilities/modifier_knockup", LUA_MODIFIER_MOTION_NONE)
    ...
    LinkLuaModifier("modifier_shield", "abilities/modifier_shield", LUA_MODIFIER_MOTION_NONE)
end
