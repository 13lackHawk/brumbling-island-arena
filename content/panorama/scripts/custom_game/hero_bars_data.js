...
AddStatusEffect("modifier_nevermore_r", "#StatusUltraFear", "#5e679b", 2);
...
AddStatusEffect("modifier_drow_w", "#StatusFear", "#5e679b", 2);
...
AddStatusEffect("modifier_tiny_r_root", "#StatusRooted", "#3BC600");
AddStatusEffect("modifier_drow_r", "#StatusRooted", "#6c4ddb");
AddStatusEffect("modifier_brew_q", "#StatusHangover", "#AF9200");
...
AddStatusEffect("modifier_rubick_q", "#StatusRecast", "#ffffff");
...
AddUltimateAbility("axe_r",  "#e61212");