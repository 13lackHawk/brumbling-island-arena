...
LinkLuaModifier("modifier_ursa_q_proc", "abilities/ursa/modifier_ursa_q_proc", LUA_MODIFIER_MOTION_NONE)
...
function ursa_q:OnSpellStart()
    ...
    hero:AreaEffect({
        ...
        modifier = { name = "modifier_ursa_q_proc", duration = 0.8, ability = self }
    })
