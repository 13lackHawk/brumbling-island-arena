...
function self:OnSpellStart()
    ...
    local modStacks = modifier:GetStackCount()
        ...
        if (hero:HasModifier("modifier_gyro_e")) then
            ...
            projectile = ArcProjectile(self.round, {
                ...
                hitParams = {
                    ...
                    damage = modStacks,
                    damagesTrees = true,
                    modifier = { name = "modifier_stunned_lua", duration = 0.4 * modStacks, ability = self }
                },
            ...
            projectile = DistanceCappedProjectile(hero.round, {
                ...
                hitModifier = { name = "modifier_stunned_lua", duration = 0.4 * modStacks, ability = self },
                hitSound = "Arena.Gyro.HitW.Sub",
