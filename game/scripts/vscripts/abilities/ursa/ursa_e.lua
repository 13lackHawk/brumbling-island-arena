...
LinkLuaModifier("modifier_ursa_e_debuff", "abilities/ursa/modifier_ursa_e_debuff", LUA_MODIFIER_MOTION_NONE)
...
function ursa_e:OnSpellStart()
    ...
    Dash(hero, target, 1000, {
        ...
        hitParams = {
            ability = self,
            modifier = { name = "modifier_ursa_e_debuff", ability = self, duration = 1.5 }
        },
