...
function earth_spirit_q:OnSpellStart()
    ...
    local fallingSpeed = hero:HasModifier("modifier_earth_spirit_stand") and 5100 or 6000

    EarthSpiritRemnant(hero, cursor + Vector(0, 0, fallingSpeed), dir, self):Activate();
