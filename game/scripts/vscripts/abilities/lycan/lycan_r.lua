...
LinkLuaModifier("modifier_lycan_r_invul", "abilities/lycan/modifier_lycan_r_invul", LUA_MODIFIER_MOTION_NONE)
...
function lycan_r:OnSpellStart()
    ...
    hero:AddNewModifier(hero, self, "modifier_lycan_r_invul", { duration = 1.2 })
...
function lycan_r:OnChannelFinish(interrupted)
    ...
    hero:AddNewModifier(hero, self, "modifier_lycan_r", { duration = 4 })
end
